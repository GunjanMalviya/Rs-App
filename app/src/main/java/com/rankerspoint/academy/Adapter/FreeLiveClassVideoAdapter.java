...
public class FreeLiveClassVideoAdapter extends RecyclerView.Adapter<FreeLiveClassVideoAdapter.BannerImage> {


    private Context context;
    List<HomeVideoFreeTopModel> freeVideoModels;

    public FreeLiveClassVideoAdapter(Context context, List<HomeVideoFreeTopModel>  freeVideoModels) {
    ...
    @NonNull
    @Override
    public FreeLiveClassVideoAdapter.BannerImage onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull FreeLiveClassVideoAdapter.BannerImage holder, int position) {
//        Log.e("tag", "onBindViewHolder: " + images.get(position));
        final HomeVideoFreeTopModel freeVideoModel = freeVideoModels.get(position);
      ...
      //  picasso.load(images.get(position)).error(R.mipmap.ic_launcher).into(holder.img);
        ...
        holder.card_liveVideo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                editor.putString("FeeStatusMentor", freeVideoModel.getExtra5());
                editor.apply();
try {
  //  Log.d("linktype:--", freeVideoModel.getLinkType().toString());
    if (freeVideoModel.getLinkType().trim().equals("Youtube")) {
    ...
    } else if (freeVideoModel.getLinkType().trim().equals("Normal")) {
