...
public class GetMockTestBySeriesByCourseAdapter extends RecyclerView.Adapter<GetMockTestBySeriesByCourseAdapter.BannerImage> {

RecyclerView recy_subpreexam;
    List<GetMockTestSeriesByCourseModel> getPreEaxmModels;
    Context context;
    //declare interface
    ...
    public GetMockTestBySeriesByCourseAdapter(Context context, List<GetMockTestSeriesByCourseModel> getPreEaxmModels, RecyclerView recy_subpreexam, OnItemClicked onClick ) {
    ...
    @NonNull
    @Override
    public GetMockTestBySeriesByCourseAdapter.BannerImage onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull GetMockTestBySeriesByCourseAdapter.BannerImage holder, int position) {





        final GetMockTestSeriesByCourseModel getPreEaxmModel = getPreEaxmModels.get(position);


        holder.txtTitleCourse.setText(getPreEaxmModel.getName());
