...
public class LiveClassesListHomeCateAdapter extends RecyclerView.Adapter<LiveClassesListHomeCateAdapter.BannerImage> {
    List<LiveClassesHomeCateModel> getPreEaxmModels;
    Context context;

    public LiveClassesListHomeCateAdapter(Context context, List<LiveClassesHomeCateModel> getPreEaxmModels) {
    ...
    @NonNull
    @Override
    public LiveClassesListHomeCateAdapter.BannerImage onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.live_layout_class_list, parent, false);
        return new BannerImage(view);
    }

    @Override
    public void onBindViewHolder(@NonNull LiveClassesListHomeCateAdapter.BannerImage holder, int position) {
//        Log.e("tag", "onBindViewHolder: " + images.get(position));
        ...
        final LiveClassesHomeCateModel getPreEaxmModel = getPreEaxmModels.get(position);
...
//        }
    ...
    public static class BannerImage extends RecyclerView.ViewHolder {
        ...
        public BannerImage(@NonNull View itemView) {
            super(itemView);
            txt_start = itemView.findViewById(R.id.tv_title);
