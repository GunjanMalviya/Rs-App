...
import com.rankerspoint.academy.Adapter.GetAllOfflineAdapter;
...
public class OfflineVideoList extends AppCompatActivity {
    String str;
    ArrayList<String> al;
    ...
    GetAllOfflineAdapter getAllOfflineAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Tools.setSystemBarLight(this);   imgBack=findViewById(R.id.imgBack);
        ...
        imgBack.setOnClickListener(new View.OnClickListener() {
           ...
           tv_toolbar_title.setText("Download Video");
...
//        lv.setAdapter(adapter);
        ...
        recyclerViewvideo.setLayoutManager(new GridLayoutManager(OfflineVideoList.this,1));
        String getUrl=GetFiles(Environment.getExternalStorageDirectory().getAbsolutePath()+"/"+"android"+"/"+"data"+"/"+getPackageName()+"/files"+"/"+"Movies");
    ...
    private String GetFiles(String path) {
        ...
        if(allfiles !=null && allfiles.length>0) {
            for(int i=0;i<allfiles.length;i++) {
                ...
                offlineVideoModel.setVideoSize(allfiles[i].length());
       ...
       // Toast.makeText(this, "Data count : "+getAllQuestionModels.size(), Toast.LENGTH_SHORT).show();
        getAllOfflineAdapter=new GetAllOfflineAdapter(OfflineVideoList.this,getAllQuestionModels);
...
File f=new File(Environment.getExternalStorageDirectory().getAbsolutePath()+"/"+"android"+"/"+"data"+"/"+getPackageName()+"/files"+"/"+"Movies/"+Filename);
if(f.exists()) {
    f.delete();
    Toast.makeText(OfflineVideoList.this, "File deleted...!!!", Toast.LENGTH_SHORT).show();
    GetFiles(Environment.getExternalStorageDirectory().getAbsolutePath()+"/"+"android"+"/"+"data"+"/"+getPackageName()+"/files"+"/"+"Movies");
    mBottomSheetDialog.dismiss();

}
else{
    Toast.makeText(OfflineVideoList.this, "File not found...!!!", Toast.LENGTH_SHORT).show();
}
                //remove file
            }
        });
