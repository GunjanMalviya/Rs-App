...
public class EmailRegister extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onClick(View view) {
                ...
                if (edt_txt_emailmob.getText().toString().equals(""))
                {
                    ...
                    if (isNetworkConnected()) {
                        ...
                        {
                            Toast.makeText(EmailRegister.this, "ex"+ex, Toast.LENGTH_SHORT).show();
                        }
                        progressDialog.show();
                    }
                    else {
                        Toast.makeText(EmailRegister.this, "No internet!!", Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
        ...
        Login_sign.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(EmailRegister.this,Login.class);
    ...
    public void Register(JSONObject jsonObject){
        ...
        JsonObjectRequest jsonObjReq = new JsonObjectRequest(Request.Method.POST, BaseUrl.SIGNUP, jsonObject,
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            if (Succeeded.equals("True"))
                            {
                                ...
                                Toast.makeText(EmailRegister.this, message, Toast.LENGTH_SHORT).show();
                            }else {

                                error = response.getString("Errors");

                                Toast.makeText(EmailRegister.this, error, Toast.LENGTH_SHORT).show();
                            }
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(EmailRegister.this, error.getMessage(), Toast.LENGTH_SHORT).show();
                progressDialog.dismiss();
            }
        }) {
            @Override
