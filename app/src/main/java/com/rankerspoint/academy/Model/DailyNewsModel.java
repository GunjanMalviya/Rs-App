...
public class DailyNewsModel {
    ...
    public DailyNewsModel(String dailyGKId, String GKCategory, String GKName, String title, String detailsLag1, String detailsLag2, String link, String addDate, String pic1) {
        DailyGKId = dailyGKId;
