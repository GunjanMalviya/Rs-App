...
public class RecentLiveVideo extends Fragment {

    public RecentLiveVideo() {
    }

    public static RecentLiveVideo newInstance() {
        RecentLiveVideo fragment = new RecentLiveVideo();
        return fragment;
    }
    Context context;
    View view;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view= inflater.inflate(R.layout.fragment_recent_live_video, container, false);
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (jsonObject.length()>0) {
                        ...
                        getHomeCategoryNotesPdfAdapter = new LiveClassesListHomeCateAdapter(context,getHomeCategorymodels);
